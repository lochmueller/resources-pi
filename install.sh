...
echo "------------ Keep in mind to disable the serial port via `sudo raspi-config` Explain: https://www.youtube.com/watch?v=XtsI8kQ3A2E"

echo "------------ Check if there are serial data via `screen /dev/ttyS0 9600` - exit with CRTL+A -> k -> y"
